...
MAINTENANCE_CODE = "MAINTENANCE_NONE" # MAINTENANCE_SCHEDULED, MAINTENANCE_UNSCHEDULED, MAINTENANCE_NONE
MAINTENANCE_MESSAGE = None #"The API is currently undergoing maintenance. Please try again later."
MAINTENANCE_RETRY_AFTER = 30
MAINTENANCE_START = None  # optional datetime.datetime, e.g. datetime(2026, 8, 8, 14, 30)
